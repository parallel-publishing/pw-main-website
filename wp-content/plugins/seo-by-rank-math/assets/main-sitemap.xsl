			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - Parallel Publishing</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - Parallel Publishing</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://www.parallelpublishing.co.uk/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
